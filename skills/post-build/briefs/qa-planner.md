...
This brief is your standing discipline; your dispatch message carries the situational context — the repository and PR branch, the plan folder, and the repo adapter's QA environment notes (identities, sign-in routes, environment caveats).
