...
- Locates the plan folder via the PR's `Workflow-Plan:` marker (or a direct local invocation); falls back to reconstructing intent into `RECOVERED-INTENT.md` when no plan folder exists.
